        ...
        <div className="bg-white border border-black/[0.09] rounded overflow-hidden shadow-[0_1px_8px_rgba(0,0,0,0.05)] animate-fade-up mx-[22px]">
            ...
            <div className="flex items-center px-[22px] py-3 gap-2.5 border-b border-black/[0.09] flex-wrap">
                ...
                <div className="flex items-center gap-2.5 ml-auto">
                    ...
                    <button className="w-8 h-8 rounded-[1em] border border-black/[0.14] bg-[#f2f3f5] flex items-center justify-center cursor-pointer text-[#70747c] hover:border-black/25 hover:text-[#25272c] transition-all">
                    ...
                    <button className="h-8 px-[18px] bg-gradient-to-br from-[#3a3d44] to-[#25272c] border-none rounded-[1em] font-outfit text-[13px] font-medium text-white cursor-pointer whitespace-nowrap flex items-center gap-[5px] shadow-[0_2px_10px_rgba(0,0,0,0.25)] hover:opacity-[0.88] transition-opacity">
                        + Nuevo ingreso
                    </button>
                </div>
            </div>
